      ...
      <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-4">
        <div>
          ...
          <p className="mt-1 text-sm text-slate-400">
            Manage your industrial ecosystem, sales pipeline, and logistics
            from a central hub.
          </p>
        </div>
        <div className="flex items-center gap-3">
          <div className="inline-flex items-center gap-2 rounded-lg bg-slate-800 border border-slate-700 px-4 py-2.5 text-sm font-medium text-slate-300">
            <Calendar className="size-4 text-slate-500" /> Oct 24 – Nov 24,
            2024
          </div>
                  ...
                  >
                    ...
                    <td className="py-3 pr-3">
                      <span className="inline-flex items-center gap-1.5 text-slate-300">
                        <span
                          className={`size-1.5 rounded-full ${statusDot(d.status)}`}
                        />
                        {d.status}
                      </span>
                    </td>
